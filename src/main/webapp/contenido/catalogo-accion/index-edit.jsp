...
<head>
<title>Modificar meta intermedia</title>
<jsp:text>
	<![CDATA[ 
		...
		<table border="0">
			<tr>
				<td colspan="2"><s:if
						...
						<label for="txtPeriodoRestrictivo">El período debe estar
							entre <s:property
						...
						<label for="txtPeriodoRestrictivo">El período relativo
