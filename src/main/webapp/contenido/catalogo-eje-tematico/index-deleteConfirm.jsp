...
<head>
	<title>Eliminar eje tematico ${nbEjeTematico}</title>
	<jsp:text>
		<![CDATA[ 
...
<h1>Eliminar Eje Temático</h1>
	...
	<s:form action="%{#request.contextPath}/catalogo-eje-tematico/%{idEje}"
		...
		<td><s:textarea  rows="5" cols="50"  id="txtNombre" name="descripcion" disabled="true" /></td>
		</tr>
		<tr>
