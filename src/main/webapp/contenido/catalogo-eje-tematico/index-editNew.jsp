...
<jsp:root xmlns:jsp="http://java.sun.com/JSP/Page" version="2.0"
	...
	<head>
	<title>Nuevo Eje Tematico</title>
	</head>
	<body>
	<h1>Agregar Eje Temático</h1>
	...
	<s:form action="%{#request.contextPath}/catalogo-eje-tematico"
		method="post" theme="simple" acceptcharset="UTF-8">
		<table>
		<tr>
		<td><label>Nombre:</label></td>
		<td><s:textfield id="txtNombre" name="model.nombre" maxlength="249" /></td>
		</tr>
		<tr>
