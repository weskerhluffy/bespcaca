		...
		<table>
			...
			@mx.ipn.escom.cdt.besp.modelo.PerfilUsuario@GERENTE}">
				<tr>
					<td>Coordinadores:</td>
					<td>
					<s:select list="listCoordinadores" listValue="nombre" 
					 listKey="idUsuario"
					name="idCoordinadorSel" headerValue="- - Seleccione una opción - -" headerKey="-1"
			requiered="true"
					/>
					</td>
				</tr>
			...
			<s:else>
				...
				<tr>
					...
					<td><s:textfield id="txtAreaResp"
							name="usuarioActual.getArea().getNombre()" disabled="true" />
					</td>
				</tr>
				<tr>
			...
			<tr>
				<td><label>Nombre del Proyecto:</label>
				</td>
				<td><s:textfield id="txtNomProy" name="model.nombre" />
				</td>
			</tr>
			<tr>
				<td><label>Siglas:</label>
				</td>
				<td><s:textfield id="txtSiglasProy" name="model.siglas" />
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="2" align="center">
					...
					</div> <s:hidden id="banderaTipoPeriodo" name="banderaTipoPeriodo" /></td>
			</tr>
			<tr>
