	...
	<div id="pageMain">
		...
		<div class="menu">
			...
			<s:if
				...
				<br />
				<a class="selected"
					href="${pageContext.request.contextPath}/catalogo-tipo-contacto">Tipo de contacto</a>
				<br />
				...
				<a class="selected"
					...
					<br />	
				<a class="selected"
					href="${pageContext.request.contextPath}/catalogo-tema-transversal">Temas transversales</a>
				<br />
				<a class="selected"
...
<!-- 					de niveles</a> -->
			...
			<s:if
				...
				<h3>Proyectos</h3>
				<a class="selected"
					href="${pageContext.request.contextPath}/proyectos-disponibles/">Ver proyectos disponibles</a>
				<br />
				<a class="selected"
...
<!-- 				<br /> -->
			...
			<s:if
				...
				<a class="selected"
					href="${pageContext.request.contextPath}/consultar-proyectos">Consultar	proyectos</a>
				<br />
				<a class="selected"
